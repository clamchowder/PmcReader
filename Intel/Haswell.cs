...
namespace PmcReader.Intel
{
    public class Haswell : ModernIntelCpu
    {
        ...
        public class OpDelivery : MonitoringConfig
        {
            ...
            public OpDelivery(Haswell intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class LoadDataSources : MonitoringConfig
        {
            ...
            public string[] columns = new string[] { "Item", "Active Cycles", "Instructions", "IPC", "Ret. Loads", "L1/LFB %", "L2 %", "L3 %", "DRAM %" };
        ...
        public class L1DFill : MonitoringConfig
        {
            ...
            public L1DFill(Haswell intelCpu)
            {
                cpu = intelCpu;
            }
